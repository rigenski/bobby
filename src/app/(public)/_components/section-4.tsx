                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-1/2">
                            <div className="flex flex-col gap-4">
                                <h2
                                    className="text-5xl font-bold italic text-white [text-shadow:2px_2px_0px_#2D384D]"
                                    data-aos="fade-up"
                                    style={{
                                        WebkitTextStroke: '1px #2D384D',
                                    }}
                                >
                                    The world won’t slow
                                    <br /> down, but you can. Let
                                ...
                                <div className="flex items-center gap-4">
                                    <Link
                                        ...
                                        data-aos-delay="200"
                                    >
                                        <span>Start Your Journey with Boby.</span>
                                        <span>
                                            <svg
                            ...
                            <div className="mt-4 flex justify-end">
                                <Image
                                    src="/assets/homepage/section-2/access.png"
                                    alt=""
                                    width={480}
                                    height={480}
                                    className="h-[160px] w-auto rotate-[60deg]"
                                />
                            </div>
                        </div>
                        <div className="w-1/2">
                            <div className="flex w-full items-center justify-center">
                                <div className="flex size-[420px] items-center justify-center overflow-hidden rounded-full bg-[#2D384D]">
                                    <div className="-mt-4 size-[400px] overflow-hidden rounded-full">
                                        <video src="/assets/homepage/section-4/video.mp4" autoPlay loop muted />
                                    </div>
                                </div>
                            </div>
                        </div>
